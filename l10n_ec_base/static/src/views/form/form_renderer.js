...
patch(FormRenderer.prototype, {
    setup() {
        ...
        this.chatterState = useState({
            width: browser.localStorage.getItem('l10n_ec_base.width'),
        });
    ...
    onStartChatterResize(ev) {
        ...
        const resizePanel = (ev) => {
            ...
            browser.localStorage.setItem('l10n_ec_base.width', newWidth);
    ...
    onDoubleClickChatterResize(ev) {
    	browser.localStorage.removeItem('l10n_ec_base.width');
